...
export abstract class IpxApiCaller {
  ...
  public abstract getStateByNumber(platform: IPXPlatform): Promise<Map<string, boolean>>;
  public abstract getAnaPositionByNumer(platform: IPXPlatform): Promise<Map<string, number>>;
